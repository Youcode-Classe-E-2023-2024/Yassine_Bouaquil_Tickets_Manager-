    ...
    <div class="flex md:order-2">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
        ...
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          ...
          <button class="bg-blue-500 text-white font-bold py-2 px-4 rounded opacity-100 cursor-pointer">
Add Tickets</button>
    ...
    <div class="flex  items-center h-screen">
        <div class="bg-white p-8 rounded h-screen shadow-md">
            <div class="mb-6">
                <a href="login.php"
            ...
            <div>
                <a href="register.php"
                    class="block w-full bg-green-500 text-white p-2 rounded-md hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105">Register</a>
            </div>
        </div>
    </div>
  </nav>
