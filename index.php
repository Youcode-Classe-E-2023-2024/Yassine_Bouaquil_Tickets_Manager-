...
Add Tickets</button></a>
    ...
    <div class="flex  items-center justify-center">
        <div class="bg-white p-8 rounded   shadow-md">
            <div class="">
                <a href="login.php"
                    class="block w-full bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105">Login</a>
            </div>

            <div>
                <a href="newuser.php" class="block w-full bg-green-500 text-white p-2 rounded-md hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105">Register</a>
            </div>
        </div>
    </div>
  </nav>
...
<div
  ...
  style="background-image: url('image/e1.jpg'); height: 400px">
  <div
    class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed"
    style="background-color: rgba(0, 0, 0, 0.6)">
    <div class="flex h-full items-center justify-center">
      <div class="text-white">
        <h2 class="mb-4 text-4xl font-semibold">Le commerce électronique n'est pas seulement sur la vente, c'est l'art de créer une expérience mémorable pour chaque clic</h2>
        <h4 class="mb-6 text-xl font-semibold">!!!!!!</h4>
        <a href="newuser.php"><button
          type="button"
