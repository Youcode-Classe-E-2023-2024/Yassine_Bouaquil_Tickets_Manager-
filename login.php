...
Add Tickets</button>
    ...
    <div class="bg-white p-8 rounded shadow-md w-96 mx-auto mt-8">
        ...
        <form action="userLogin.php" method="post">
            ...
            <button type="submit" class="bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600">Login</button>
        </form>
    </div>
</body>
</html>
