...
<body class="bg-gray-100 min-h-screen">
                ...
                <ul
                    ...
                    <li>
                        <a href="#"
                            ...
                            aria-current="page">My Tickets</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <button
                        class="bg-blue-500 text-white font-bold py-2 px-4 rounded opacity-100 cursor-pointer">
                        Add Tickets</button>
    ...
    <form action="userRregister.php" method="post">
    ...
    <div class="mb-4">
        ...
        <button type="submit" name="submit" class="bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600">Register</button>
    </div>
</form>
